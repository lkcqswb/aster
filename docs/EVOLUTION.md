...
- [Pi sessions](https://github.com/earendil-works/pi/blob/main/packages/coding-agent/docs/session.md): resumable conversation context and branching.
...
Next: steering and durable follow-up queues, then richer project context and reusable skills.
