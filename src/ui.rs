...
impl App {
   ...
   "/pet"=>{if arg=="off"||arg.is_empty()&&self.companion.is_some(){self.companion=None;self.portrait=Shared::default();}else{self.companion=Some(Companion::start(self.cfg.clone()));}self.last_image=None;},
